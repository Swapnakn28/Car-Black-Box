...
void change_pass(char key) {
    ...
    if (ev_ind < 9)
        prev_ind = ev_ind;
    clcd_print("Enter Old Paswod", (0x80 + (0)));
    while (1) {
        switch_scroll(key);
        if (count < 4) {
            key = read_switches(1);
            ...
            if (valid == 0)
            {
                ...
                if (flag == 1)
                {
                    ...
                    clcd_print("Incorrect password ", (0x80 + (0)));
                ...
                valid = 1;
                clcd_write(0x01, 0);
                clcd_print("Enter New PW    ", (0x80 + (0)));
                ...
                if (valid == 2)
                {
                    ...
                    clcd_print("Changed password", (0x80 + (0)));
                ...
                } else
                {
                    ...
                    count = 0;
                    clcd_write(0x01, 0);
                    clcd_print("Re Enter New PW ", (0x80 + (0)));
                }
            }
        }
